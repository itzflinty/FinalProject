...
public class OneMoreOneLess : MonoBehaviour
{
    ...
    void y1OneMoreoneLess()
    {
        ...
        if (fiftyFifty >= 0 && fiftyFifty <= 50)
        {
            valueA.text = "" + randomNumber;
            OmOl.text = " One More ";
            ...
            for (int i = 0; i < ansButtons.Length; i++)
            {
                ...
                else
                {
                    ...
                    ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 101);
                    if (ansButtons[i].GetComponentInChildren<Text>().text == "" + numberOneMore)
                    {
                        ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 101);
                    }
        ...
        else if (fiftyFifty >= 51 && fiftyFifty <= 100)
        {
            ...
            OmOl.text = " One Less ";
            Debug.Log("Answer" + randomNumber);
            Debug.Log("One more" + numberOneLess);
            locationOfAnswer = Random.Range(0, ansButtons.Length);
            for (int i = 0; i < ansButtons.Length; i++)
            {
                if (i == locationOfAnswer)
                ...
                else
                {
                    //for other ans button we assign random values
                    ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 101);
                    if (ansButtons[i].GetComponentInChildren<Text>().text == "" + numberOneLess)
                    {
                        ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 101);
                    }
    ...
    void y1Shapes3D()
    {
        ...
        for (int i = 0; i < ansButtons.Length; i++)
        {
            ...
            {
                //for other ans button we assign random values
                ansButtons[i].GetComponentInChildren<Text>().text = "" + shapeName[Random.Range(0, 5)];
                if (ansButtons[i].GetComponentInChildren<Text>().text == "" + answer)
                {
                    ansButtons[i].GetComponentInChildren<Text>().text = "" + shapeName[Random.Range(0, 5)];
                }
    ...
    void y1ShapesMix()
    {
        string[] shapeName = new string[] { "circle", "oval", "pentagon", "rectangle", "semicircle", "square",
                                            "triangle", "cone", "cube", "cuboid", "cylinder", "pyramid", "sphere" };
        ...
        for (int i = 0; i < ansButtons.Length; i++)
        {
            ...
            {
                //for other ans button we assign random values
                ansButtons[i].GetComponentInChildren<Text>().text = "" + shapeName[Random.Range(0, 12)];
                if (ansButtons[i].GetComponentInChildren<Text>().text == "" + answer)
                {
                    ansButtons[i].GetComponentInChildren<Text>().text = "" + shapeName[Random.Range(0, 12)];
                }
    ...
    void y1MonthsOfTheYear()
    {
        ...
        for (int i = 0; i < ansButtons.Length; i++)
        {
            ...
            else if (x >= 67 && x <= 100)
            {
                ...
                valueA.text = "What is the  " + randomNumber + end[randomNumber] + " months in the year";
                if (i == locationOfAnswer)
                {
                    ansButtons[i].GetComponentInChildren<Text>().text = "" + answer;
                }
    ...
    void y1PlaceValues()
    {
        ...
        for (int i = 0; i < ansButtons.Length; i++)
        {
            if (third >= 1 && third <= 33)
            {
                ...
                {
                    //for other ans button we assign random values
                    ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 9);
                    if (ansButtons[i].GetComponentInChildren<Text>().text == "" + units)
                    {
                        ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 9);
                    }
                    while (ansButtons[i].GetComponentInChildren<Text>().text == "" + units)
                    {
                        //we make sure that only one button has answer values 
                        ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 9);
                    }
            ...
            else if (third >= 34 && third <= 66)
            {
                ...
                else
                {
                    ...
                    while (ansButtons[i].GetComponentInChildren<Text>().text == "" + tens)
                    {
                        //we make sure that only one button has answer values 
                        ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 9);
                    }
    ...
    void y1Sizes()
    {
        ...
        if (half >= 1 && half <= 50)
        {
            answer = LargeImageName[k];
        }
        else if (half >= 51 && half <= 100)
        {
            answer = SmallImageName[k];
        }
        //a     b       c
        //if answer is locaiton a
        //andwer is large
        //a is large
        //b/c is small or medium

        //answer is medium
        //a is medium
        //b/c is small or large

        //answer is small
        //a is small
        //b/c is medium or large
        //repeat for location b and c

        for (int i = 0; i < ansButtons.Length; i++)
        {
            if (1 == locationOfAnswer)
            {
                if (half >= 1 && half <= 50)
                {
                    valueB.text = "Which is the largest?";
                    if (answer == LargeImageName[k])
                    {
    ...
    {
        int randomNumber = Random.Range(1, 299);
        int fiftyFifty = Random.Range(0, 100);
        int numberOneMore = randomNumber + 1;
        int numberOneLess = randomNumber - 1;
        Debug.Log(randomNumber);
        if (fiftyFifty >= 0 && fiftyFifty <= 50)
        {
            ...
            for (int i = 0; i < ansButtons.Length; i++)
            {
                ...
                {
                    //for other ans button we assign random values
                    ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 301);
                    if (ansButtons[i].GetComponentInChildren<Text>().text == "" + numberOneMore)
                    {
                        ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 301);
                    }
        ...
        for (int i = 0; i < ansButtons.Length; i++)
        {
            ...
            else if (third >= 67 && third <= 99)
            {
                ...
                else
                {
                    ...
                    while (ansButtons[i].GetComponentInChildren<Text>().text == "" + hundreds)
                    {
                        //we make sure that only one button has answer values 
                        ansButtons[i].GetComponentInChildren<Text>().text = "" + Random.Range(0, 9);
                    }
